...
public class ErrorResponse {
    ...
    @Expose
    private String message = "Ocorreu um erro inesperado. Por favor, tente novamente.";
    @Expose
    private String messageServer = "Ocorreu um erro inesperado. Por favor, tente novamente.";
